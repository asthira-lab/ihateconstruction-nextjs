...
export const CALCULATOR_SLUGS = ["brick", "concrete", "paint", "steel", "tile", "rebar", "concrete-volume", "concrete-slab", "concrete-footing", "concrete-foundation", "concrete-wall", "concrete-driveway", "concrete-staircase"] as const;
