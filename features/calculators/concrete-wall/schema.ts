// Zod schemas for the concrete-wall calculator API contract.
...
// Wall is a vertical prism: length × height footprint at a uniform thickness.
export const concreteWallRequestSchema = z.object({
...
export const concreteWallResponseSchema = z.object({
  input: z.object({
    length: lengthQuantitySchema,
    height: lengthQuantitySchema,
    thickness: lengthQuantitySchema,
